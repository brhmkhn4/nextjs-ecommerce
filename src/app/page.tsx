...
export default async function Home() {
  ...
  const data: IBook[] = await getData("https://simple-books-api.glitch.me/books")
  console.log(data)
  ...
  <section className="text-gray-700 body-font" id="gallery">
    ...
    <div className="grid grid-cols-1 place-items-center sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 p-4">
